...
class InformationContainer extends StatefulWidget {
  ...
  final Function(bool) isBookmarkedCallback;
...
class FoodInformationContainer extends StatefulWidget {
  final String result;
  final int noOfObjectsFound;
  final bool isBookmarked;
  final String description;
  ...
  const FoodInformationContainer(
      {super.key,
      required this.result,
      required this.noOfObjectsFound,
      required this.isBookmarked,
  ...
  @override
  State<FoodInformationContainer> createState() =>
      _FoodInformationContainerState();
}

class _FoodInformationContainerState extends State<FoodInformationContainer> {
...
class AnimalInformationContainer extends StatefulWidget {
  final String result;
  final int noOfObjectsFound;
  final bool isBookmarked;
  final String description;
  ...
  const AnimalInformationContainer({
    super.key,
    required this.result,
    required this.noOfObjectsFound,
    required this.isBookmarked,
  ...
  @override
  State<AnimalInformationContainer> createState() =>
      _AnimalInformationContainerState();
}
